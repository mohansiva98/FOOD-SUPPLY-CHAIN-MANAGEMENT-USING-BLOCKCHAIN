<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Disregister.aspx.cs" Inherits="Disregister" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="background-image:url(img/f6.jpg);background-size:cover">
         <br />
         <br />

     <div class="form-group" style="margin-left:400px;margin-top:80px;background-color:rgba(73, 246, 66, 0.81);width:500px;height:900px;padding:20px 20px 20px 20px">
        <br />
        <div  style="margin-left:80px;margin-top:20px;font-family:'Book Antiqua'">
        <h3 style="text-decoration:underline;font-family:Elephant;font-weight:100">DISTRIBUTER REGISTER </h3>
        <br />
            <h3>Profile</h3>
            <br />
        <asp:Label ID="Label1" runat="server" Text="DISTRIBUTER ID:"></asp:Label>
        <asp:TextBox ID="TextBox1" CssClass="form-control" style="width:300px" runat="server"></asp:TextBox>
            
        <asp:Label ID="Label2" runat="server" Text="DISTRIBUTER NAME:"></asp:Label>
