<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="farmerregister.aspx.cs" Inherits="farmerregister" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="background-image:url(img/f7.jpg);background-size:cover">
         <br />
         <br />
     ...
     <div class="form-group" style="margin-left:400px;margin-top:80px;background-color:rgba(73, 246, 66, 0.81);width:500px;height:900px;padding:20px 20px 20px 20px">
        ...
        <h3 style="text-decoration:underline;font-family:Elephant;font-weight:100">FARMER'S REGISTER </h3>
        <br />
            <h3>Profile</h3>
            <br />
        <asp:Label ID="Label1" runat="server" Text="FARMER ID:"></asp:Label>
