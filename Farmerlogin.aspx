<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Farmerlogin.aspx.cs" Inherits="Framerlogin" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="background-image:url(img/f1.jpg);background-size:cover">
        <br />
     <div class="form-group" style="margin-left:400px;margin-top:80px;background-color:rgba(251, 217, 10, 0.56);width:500px;height:320px">
        <br />
        <div  style="margin-left:80px;margin-top:20px;font-family:'Book Antiqua'">
        <h3 style="text-decoration:underline;font-family:Elephant;font-weight:100">Farmer's Login</h3>
        <br />
        <asp:Label ID="Label1" runat="server" Text="Farmer Id:" style="font-weight:bolder"></asp:Label>
        <asp:TextBox ID="TextBox1" CssClass="form-control" style="width:300px" runat="server"></asp:TextBox>
            <br />
        <asp:Label ID="Label2" runat="server" Text="Farmer Password:" style="font-weight:bolder"></asp:Label>
